...
def wait_for_exp_list(status_url: str, token: str | None = None, timeout: int = 300, interval: float = 2.0):
    """Poll the status URL until SUCCESS/FAILURE/timeout. Return exp_list on success."""
...
# --- your existing fns assumed available: process_cmdline, get_limits, suggest_single, suggest_multi, propose_with_files ---
...
if __name__ == "__main__":
    ...
    # Notify completion
    resp = requests.post(url_complete)
