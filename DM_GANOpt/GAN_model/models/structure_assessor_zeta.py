...
class Assessor(nn.Module):
    ...
    # In this version, I want to implement more aggressive overhangs penalty 
    ...
    def overhang_score(self, voxel_grid):
        ...
        threshold = 0.05  # voxels with <5% support are penalized
        margin = 0.1      # tighten the mask
        ...
        for z in range(1, D):
            ...
            unsupported_mask = ((support_ratio + margin) < threshold).float()
